...
function convertionRatio(): void
{
    ...
    $ratio = (isset(($registered_users)["user_count"]) ? $registered_users["user_count"] : 0) ? 100 / intval(isset(($registered_users)["user_count"]) ? $registered_users["user_count"] : 0) * intval(($total_orders)["order_count"]) : 0;
